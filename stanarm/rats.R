...
#Learning objective 1: Understan Stan coding of random coefficient models for repeated measures
#Learning objective 2: Assess the effect of alterntative Stan syntaxes for fitting identical model
#learning objective 3: Compare inferences under different models
